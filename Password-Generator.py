...
Title = Label(root, text="Password Generator", bg="white", fg="red", font=("futura", 15, "bold"))
Title.pack(anchor="center", pady="20px")

length = Label(root, text="User Input Length of Your Password :- ", fg="#2B1B17", bg="white", font=("ubuntu", 12))
...
generate_btn = Button(root, text="Generate Password", bg="pink", fg="black", font=("ubuntu", 15), cursor="hand2", command=password_generate)
generate_btn.bind("<Enter>", on_enter)
generate_btn.bind("<Leave>", on_leave)
generate_btn.pack(anchor="center", pady="50px")

result_lable = Label(root, text="Display Generated Password :- ", bg="white", fg="#2B1B17", font=("ubuntu", 12))
